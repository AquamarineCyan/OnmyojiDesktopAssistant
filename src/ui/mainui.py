...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_qiling_jieqi.setGeometry(QRect(10, 80, 50, 20))
        ...
        self.label_qiling_jieqi_stone.setGeometry(QRect(5, 120, 40, 20))
        ...
        self.combo_qiling_jieqi_stone.setGeometry(QRect(50, 120, 70, 20))
        self.spin_qiling_jieqi_stone = QSpinBox(self._4_qiling)
        self.spin_qiling_jieqi_stone.setObjectName(u"spin_qiling_jieqi_stone")
        self.spin_qiling_jieqi_stone.setGeometry(QRect(125, 120, 88, 20))

...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_yingjieshilian_exp.setGeometry(QRect(30, 70, 100, 25))
        ...
        self.button_yingjieshilian_skill.setGeometry(QRect(30, 100, 100, 25))
        self.combo_yingjieshilian = QComboBox(self._5_yingjieshilian)
        self.combo_yingjieshilian.setObjectName(u"combo_yingjieshilian")
        self.combo_yingjieshilian.setGeometry(QRect(30, 30, 140, 25))
        self.stackedWidget.addWidget(self._5_yingjieshilian)
        self._6_huijuan = QWidget()
        self._6_huijuan.setObjectName(u"_6_huijuan")
        self.groupBox_huijuan_jiejietupo = QGroupBox(self._6_huijuan)
        self.groupBox_huijuan_jiejietupo.setObjectName(u"groupBox_huijuan_jiejietupo")
        self.groupBox_huijuan_jiejietupo.setGeometry(QRect(10, 50, 190, 125))
        self.label_huijuan_jiejietupo_target_level = QLabel(self.groupBox_huijuan_jiejietupo)
        self.label_huijuan_jiejietupo_target_level.setObjectName(u"label_huijuan_jiejietupo_target_level")
        self.label_huijuan_jiejietupo_target_level.setGeometry(QRect(10, 62, 48, 20))
        self.label_huijuan_jiejietupo_current_level = QLabel(self.groupBox_huijuan_jiejietupo)
        self.label_huijuan_jiejietupo_current_level.setObjectName(u"label_huijuan_jiejietupo_current_level")
        self.label_huijuan_jiejietupo_current_level.setGeometry(QRect(10, 36, 55, 20))
        self.button_huijuan_jiejietupo_switch_level = QRadioButton(self.groupBox_huijuan_jiejietupo)
        self.buttonGroup_huijuan_jiejietupo_switch = QButtonGroup(MainWindow)
        self.buttonGroup_huijuan_jiejietupo_switch.setObjectName(u"buttonGroup_huijuan_jiejietupo_switch")
        self.buttonGroup_huijuan_jiejietupo_switch.addButton(self.button_huijuan_jiejietupo_switch_level)
        self.button_huijuan_jiejietupo_switch_level.setObjectName(u"button_huijuan_jiejietupo_switch_level")
        self.button_huijuan_jiejietupo_switch_level.setGeometry(QRect(5, 10, 70, 20))
        self.comboBox_huijuan_jiejietupo_current_level = QComboBox(self.groupBox_huijuan_jiejietupo)
        self.comboBox_huijuan_jiejietupo_current_level.setObjectName(u"comboBox_huijuan_jiejietupo_current_level")
        self.comboBox_huijuan_jiejietupo_current_level.setGeometry(QRect(80, 35, 90, 23))
        self.comboBox_huijuan_jiejietupo_target_level = QComboBox(self.groupBox_huijuan_jiejietupo)
        self.comboBox_huijuan_jiejietupo_target_level.setObjectName(u"comboBox_huijuan_jiejietupo_target_level")
        self.comboBox_huijuan_jiejietupo_target_level.setGeometry(QRect(80, 60, 90, 23))
        self.button_huijuan_jiejietupo_fail = QCheckBox(self.groupBox_huijuan_jiejietupo)
        self.button_huijuan_jiejietupo_fail.setObjectName(u"button_huijuan_jiejietupo_fail")
        self.button_huijuan_jiejietupo_fail.setGeometry(QRect(80, 10, 90, 20))
        self.button_huijuan_jiejietupo_switch_rule = QRadioButton(self.groupBox_huijuan_jiejietupo)
        self.buttonGroup_huijuan_jiejietupo_switch.addButton(self.button_huijuan_jiejietupo_switch_rule)
        self.button_huijuan_jiejietupo_switch_rule.setObjectName(u"button_huijuan_jiejietupo_switch_rule")
        self.button_huijuan_jiejietupo_switch_rule.setGeometry(QRect(5, 90, 70, 20))
        self.groupBox_huijuan_tansuo = QGroupBox(self._6_huijuan)
        self.groupBox_huijuan_tansuo.setObjectName(u"groupBox_huijuan_tansuo")
        self.groupBox_huijuan_tansuo.setGeometry(QRect(10, 0, 190, 40))
        self.huijuan_tansuo_label_numbers = QLabel(self.groupBox_huijuan_tansuo)
        self.huijuan_tansuo_label_numbers.setObjectName(u"huijuan_tansuo_label_numbers")
        self.huijuan_tansuo_label_numbers.setGeometry(QRect(10, 0, 60, 35))
        self.huijuan_tansuo_spin_times = QSpinBox(self.groupBox_huijuan_tansuo)
        self.huijuan_tansuo_spin_times.setObjectName(u"huijuan_tansuo_spin_times")
        self.huijuan_tansuo_spin_times.setGeometry(QRect(90, 7, 75, 23))
        self.huijuan_tansuo_spin_times.setMinimumSize(QSize(60, 0))
        self.huijuan_tansuo_spin_times.setFont(font3)
        self.huijuan_tansuo_spin_times.setMaximum(999)
        self.stackedWidget.addWidget(self._6_huijuan)
        ...
        self.tab_window_manager = QWidget()
        self.tab_window_manager.setObjectName(u"tab_window_manager")
        self.tab_window_manager_comboBox = QComboBox(self.tab_window_manager)
        self.tab_window_manager_comboBox.setObjectName(u"tab_window_manager_comboBox")
        self.tab_window_manager_comboBox.setGeometry(QRect(50, 60, 200, 30))
        self.tab_window_manager_apply_button = QPushButton(self.tab_window_manager)
        self.tab_window_manager_apply_button.setObjectName(u"tab_window_manager_apply_button")
        self.tab_window_manager_apply_button.setGeometry(QRect(380, 60, 80, 30))
        self.tab_window_manager_title_label = QLabel(self.tab_window_manager)
        self.tab_window_manager_title_label.setObjectName(u"tab_window_manager_title_label")
        self.tab_window_manager_title_label.setGeometry(QRect(50, 20, 100, 30))
        self.tab_window_manager_title_label.setFont(font3)
        self.tab_window_manager_preview_button = QPushButton(self.tab_window_manager)
        self.tab_window_manager_preview_button.setObjectName(u"tab_window_manager_preview_button")
        self.tab_window_manager_preview_button.setGeometry(QRect(280, 60, 80, 30))
        self.tab_window_manager_preview_image = QLabel(self.tab_window_manager)
        self.tab_window_manager_preview_image.setObjectName(u"tab_window_manager_preview_image")
        self.tab_window_manager_preview_image.setGeometry(QRect(50, 140, 400, 250))
        self.tab_window_manager_info_label = QLabel(self.tab_window_manager)
        self.tab_window_manager_info_label.setObjectName(u"tab_window_manager_info_label")
        self.tab_window_manager_info_label.setGeometry(QRect(300, 380, 150, 30))
        self.tab_window_manager_info_label.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
        self.tabWidget.addTab(self.tab_window_manager, "")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 578, 484))
        ...
        self.horizontalLayout_about1 = QHBoxLayout()
        self.horizontalLayout_about1.setObjectName(u"horizontalLayout_about1")
        self.horizontalSpacer_about1_1 = QSpacerItem(0, 0, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_about1.addItem(self.horizontalSpacer_about1_1)

        self.button_about_homePage = QPushButton(self.scrollAreaWidgetContents)
        self.button_about_homePage.setObjectName(u"button_about_homePage")
        self.button_about_homePage.setMinimumSize(QSize(120, 25))

        self.horizontalLayout_about1.addWidget(self.button_about_homePage)

        self.horizontalSpacer_about1_2 = QSpacerItem(0, 0, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_about1.addItem(self.horizontalSpacer_about1_2)

        self.button_about_helpDoc = QPushButton(self.scrollAreaWidgetContents)
        self.button_about_helpDoc.setObjectName(u"button_about_helpDoc")
        self.button_about_helpDoc.setMinimumSize(QSize(120, 25))

        self.horizontalLayout_about1.addWidget(self.button_about_helpDoc)

        self.horizontalSpacer_about1_3 = QSpacerItem(0, 0, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_about1.addItem(self.horizontalSpacer_about1_3)

        self.button_about_Qgroup = QPushButton(self.scrollAreaWidgetContents)
        self.button_about_Qgroup.setObjectName(u"button_about_Qgroup")
        self.button_about_Qgroup.setMinimumSize(QSize(120, 25))

        self.horizontalLayout_about1.addWidget(self.button_about_Qgroup)

        self.horizontalSpacer_about1_4 = QSpacerItem(0, 0, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_about1.addItem(self.horizontalSpacer_about1_4)


        self.verticalLayout_setting.addLayout(self.horizontalLayout_about1)

        self.horizontalLayout_about2 = QHBoxLayout()
        self.horizontalLayout_about2.setObjectName(u"horizontalLayout_about2")
        self.horizontalSpacer_about2_1 = QSpacerItem(0, 0, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_about2.addItem(self.horizontalSpacer_about2_1)

        self.button_about_shortCut = QPushButton(self.scrollAreaWidgetContents)
        self.button_about_shortCut.setObjectName(u"button_about_shortCut")
        self.button_about_shortCut.setMinimumSize(QSize(120, 25))

        self.horizontalLayout_about2.addWidget(self.button_about_shortCut)

        self.horizontalSpacer_about2_2 = QSpacerItem(0, 0, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_about2.addItem(self.horizontalSpacer_about2_2)

        self.button_about_appRestart = QPushButton(self.scrollAreaWidgetContents)
        self.button_about_appRestart.setObjectName(u"button_about_appRestart")
        self.button_about_appRestart.setMinimumSize(QSize(120, 25))

        self.horizontalLayout_about2.addWidget(self.button_about_appRestart)

        self.horizontalSpacer_about2_3 = QSpacerItem(0, 0, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_about2.addItem(self.horizontalSpacer_about2_3)

        self.button_about_updateRecord = QPushButton(self.scrollAreaWidgetContents)
        self.button_about_updateRecord.setObjectName(u"button_about_updateRecord")
        self.button_about_updateRecord.setMinimumSize(QSize(120, 25))

        self.horizontalLayout_about2.addWidget(self.button_about_updateRecord)

        self.horizontalSpacer_about2_4 = QSpacerItem(0, 0, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_about2.addItem(self.horizontalSpacer_about2_4)


        self.verticalLayout_setting.addLayout(self.horizontalLayout_about2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_yingjieshilian_exp.setText(QCoreApplication.translate("MainWindow", u"\u7ecf\u9a8c\u672c", None))
        self.button_yingjieshilian_skill.setText(QCoreApplication.translate("MainWindow", u"\u6280\u80fd\u672c", None))
        self.label_huijuan_jiejietupo_target_level.setText(QCoreApplication.translate("MainWindow", u"\u76ee\u6807\u7b49\u7ea7", None))
        self.label_huijuan_jiejietupo_current_level.setText(QCoreApplication.translate("MainWindow", u"\u5f53\u524d\u7b49\u7ea7", None))
        self.button_huijuan_jiejietupo_switch_level.setText(QCoreApplication.translate("MainWindow", u"\u5361\u7ea7", None))
        self.button_huijuan_jiejietupo_fail.setText(QCoreApplication.translate("MainWindow", u"\u9996\u8f6e\u9000\u7ea7", None))
        self.button_huijuan_jiejietupo_switch_rule.setText(QCoreApplication.translate("MainWindow", u"3\u80dc\u5237\u65b0", None))
        self.huijuan_tansuo_label_numbers.setText(QCoreApplication.translate("MainWindow", u"\u63a2\u7d22\u6b21\u6570", None))
        ...
        self.tab_window_manager_apply_button.setText(QCoreApplication.translate("MainWindow", u"\u5e94\u7528", None))
        self.tab_window_manager_title_label.setText(QCoreApplication.translate("MainWindow", u"\u68c0\u6d4b\u5230\u7684\u7a97\u53e3\uff1a", None))
        self.tab_window_manager_preview_button.setText(QCoreApplication.translate("MainWindow", u"\u9884\u89c8", None))
        self.tab_window_manager_preview_image.setText("")
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_window_manager), QCoreApplication.translate("MainWindow", u"\u7a97\u53e3\u7ba1\u7406", None))
        ...
        self.button_about_homePage.setText(QCoreApplication.translate("MainWindow", u"\u9879\u76ee\u4e3b\u9875", None))
        self.button_about_helpDoc.setText(QCoreApplication.translate("MainWindow", u"\u4f7f\u7528\u6587\u6863", None))
        self.button_about_Qgroup.setText(QCoreApplication.translate("MainWindow", u"\u4ea4\u6d41\u7fa4", None))
        self.button_about_shortCut.setText(QCoreApplication.translate("MainWindow", u"\u521b\u5efa\u684c\u9762\u5feb\u6377\u65b9\u5f0f", None))
        self.button_about_appRestart.setText(QCoreApplication.translate("MainWindow", u"\u91cd\u542f", None))
        self.button_about_updateRecord.setText(QCoreApplication.translate("MainWindow", u"\u66f4\u65b0\u8bb0\u5f55", None))

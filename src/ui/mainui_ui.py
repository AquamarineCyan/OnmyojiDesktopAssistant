...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tab_window_manager_label = QLabel(self.tab_window_manager)
        self.tab_window_manager_label.setObjectName(u"tab_window_manager_label")
        self.tab_window_manager_label.setGeometry(QRect(50, 20, 100, 30))
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 590, 471))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tab_window_manager_label.setText(QCoreApplication.translate("MainWindow", u"\u68c0\u6d4b\u5230\u7684\u7a97\u53e3\uff1a", None))
